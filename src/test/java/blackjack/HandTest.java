...
/* 
    ...
    public void add_Card() {
        Hand hand2 = new Hand();
        hand2.addCard(CardFactory.createCard(CardRank.two, CardSuit.Diamonds));
        Assert.assertEquals(2, hand2.showPoints());
        hand2.addCard(CardFactory.createCard(CardRank.two, CardSuit.heart));
...
*/
    ...
    public void count_Ace() {
        Hand hand = new Hand();
        hand.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Diamonds));
        Assert.assertEquals(1, hand.countAce());
        hand.addCard(CardFactory.createCard(CardRank.two, CardSuit.Diamonds));
        Assert.assertEquals(1, hand.countAce());
        hand.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Hearts));
    ...
    public void count_TenCard() {
        Hand hand = new Hand();
        hand.addCard(CardFactory.createCard(CardRank.ten, CardSuit.Diamonds));
        Assert.assertEquals(1, hand.countTenCard());
        hand.addCard(CardFactory.createCard(CardRank.nine, CardSuit.Diamonds));
        Assert.assertEquals(1, hand.countTenCard());
        hand.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Hearts));
        Assert.assertEquals(2, hand.countTenCard());

        Hand hand2 = new Hand();
        hand2.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Diamonds));
    ...
    public void sum_Points_WithoutAce() {
        Hand hand = new Hand();
        hand.addCard(CardFactory.createCard(CardRank.ten, CardSuit.Diamonds));
        hand.addCard(CardFactory.createCard(CardRank.eight, CardSuit.Diamonds));
        ...
        hand2.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Diamonds));
        Assert.assertEquals(10, hand2.sumPointsWithoutAce());
        hand2.addCard(CardFactory.createCard(CardRank.queen, CardSuit.Diamonds));
    ...
    public void sum_Points() {
        Hand hand3 = new Hand();
        hand3.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Diamonds));
        hand3.addCard(CardFactory.createCard(CardRank.two, CardSuit.Hearts));
        Assert.assertEquals(13, hand3.sumPoints());
        hand3.addCard(CardFactory.createCard(CardRank.eight, CardSuit.Hearts));
    ...
    public void sum_Points2() {
        ...
        hand3.addCard(CardFactory.createCard(CardRank.two, CardSuit.Hearts));
        Assert.assertEquals(13, hand3.sumPoints());
        hand3.addCard(CardFactory.createCard(CardRank.five, CardSuit.Hearts));
    ...
    public void sum_Points5_for_blackjack() {
        Hand hand5 = new Hand();
        hand5.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Diamonds));
        hand5.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Diamonds));
    ...
    public void sum_Points6_for_bust() {
        Hand hand6 = new Hand();
        hand6.addCard(CardFactory.createCard(CardRank.ten, CardSuit.Diamonds));
        hand6.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Diamonds));
        hand6.addCard(CardFactory.createCard(CardRank.queen, CardSuit.Diamonds));
    ...
    public void isAceForEleven() {
        Hand hand = new Hand();
        hand.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Diamonds));
        hand.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Diamonds));
        hand.addCard(CardFactory.createCard(CardRank.queen, CardSuit.Diamonds));
        ...
        Hand hand3 = new Hand();
        hand3.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Diamonds));
        hand3.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Diamonds));
        hand3.addCard(CardFactory.createCard(CardRank.queen, CardSuit.Diamonds));
        Assert.assertEquals(21, hand3.sumPoints());
    ...
    public void isDealerHandSeventeenOrMore() {
        ...
        Hand hand2 = new Hand();
        hand2.addCard(CardFactory.createCard(CardRank.seven, CardSuit.Diamonds));
        hand2.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Diamonds));
        Assert.assertEquals(17, hand2.sumPoints());
        Assert.assertTrue(hand2.isDealerHandSeventeenOrMore());

        Hand hand3 = new Hand();
        hand3.addCard(CardFactory.createCard(CardRank.six, CardSuit.Diamonds));
        hand3.addCard(CardFactory.createCard(CardRank.ace, CardSuit.Diamonds));
        Assert.assertEquals(17, hand3.sumPoints());
        Assert.assertFalse(hand3.isDealerHandSeventeenOrMore());

        Hand hand4 = new Hand();
        hand4.addCard(CardFactory.createCard(CardRank.six, CardSuit.Diamonds));
        hand4.addCard(CardFactory.createCard(CardRank.ten, CardSuit.Diamonds));
    ...
    public void is_bust() {
        Hand hand6 = new Hand();
        hand6.addCard(CardFactory.createCard(CardRank.three, CardSuit.Diamonds));
        hand6.addCard(CardFactory.createCard(CardRank.jack, CardSuit.Diamonds));
        hand6.addCard(CardFactory.createCard(CardRank.nine, CardSuit.Diamonds));
        // これは問題にならないか？
